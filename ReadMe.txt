========================================================================
		ActiveX Control DLL : ATTENDANCECARD
========================================================================

ControlWizard has created this project for your ATTENDANCECARD ActiveX Control
...
that make up your ATTENDANCECARD ActiveX Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
AttendanceCard control:

AttendanceCardCtl.h
	This file contains the declaration of the CAttendanceCardCtrl C++ class.

AttendanceCardCtl.cpp
	This file contains the implementation of the CAttendanceCardCtrl C++ class.

AttendanceCardPpg.h
	This file contains the declaration of the CAttendanceCardPropPage C++ class.

AttendanceCardPpg.cpp
	This file contains the implementation of the CAttendanceCardPropPage C++ class.

AttendanceCardCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CAttendanceCardCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file AttendanceCard.rc.
